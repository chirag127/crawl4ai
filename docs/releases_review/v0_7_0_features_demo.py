...
from crawl4ai import (AdaptiveConfig,  # New imports for v0.7.0
                      AdaptiveCrawler, AsyncUrlSeeder, AsyncWebCrawler,
                      CacheMode, CrawlerRunConfig,
                      LinkPreviewConfig, SeedingConfig, VirtualScrollConfig,
                      c4a_compile)
...
"""
    ...
    if result.success:
        print(
            f"✅ Successfully compiled to {len(result.js_code)} JavaScript statements!"
        )
