...
async def example_form_filling():
    ...
    config = CrawlerRunConfig(url="https://example.com/contact", c4a_script=form_script)
...
async def example_multi_step_workflow():
    ...
    if result.success:
        ...
        config = CrawlerRunConfig(url="https://example.com", c4a_script=workflow_script)
    else:
...
async def example_error_handling():
    ...
    try:
        config = CrawlerRunConfig(url="https://example.com", c4a_script=bad_script)
    ...
    config = CrawlerRunConfig(url="https://example.com", c4a_script=good_script)
