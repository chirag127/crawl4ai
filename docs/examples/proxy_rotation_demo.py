...
from crawl4ai import (AsyncWebCrawler, BrowserConfig, CacheMode,
                      CrawlerRunConfig, RoundRobinProxyStrategy)
            ...
            for result in results:
                if result.success:
                    ...
                    if current_proxy and ip_match:
                        ...
                        if verified:
                            print(
                                f"✅ Proxy working! IP matches: {current_proxy['ip']}"
                            )
                            success_count += 1
                        else:
                            print("❌ Proxy failed or IP mismatch!")
...
if __name__ == "__main__":
    ...
    from crawl4ai import (CrawlerMonitor, DefaultMarkdownGenerator,
                          DisplayMode, MemoryAdaptiveDispatcher)
