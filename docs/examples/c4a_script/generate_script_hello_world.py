...
def main():
    ...
    print("-" * 30)
    c4a_script = C4ACompiler.generate_script(html=html, query=goal, mode="c4a")
    print(c4a_script)
    print()
    ...
    print("-" * 30)
    js_script = C4ACompiler.generate_script(html=html, query=goal, mode="js")
    print(js_script)
    print()
    ...
    print("🔧 Generated C4A-Script:")
    print("-" * 30)
    c4a_script2 = C4ACompiler.generate_script(html=html2, query=goal2, mode="c4a")
    print(c4a_script2)
    print()
