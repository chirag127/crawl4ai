...
from .config import (DEFAULT_PROVIDER, DEFAULT_PROVIDER_API_KEY,
                     ...
                     IMAGE_SCORE_THRESHOLD, MIN_WORD_THRESHOLD, PAGE_TIMEOUT,
                     PROVIDER_MODELS_PREFIXES,
                     SCREENSHOT_HEIGHT_TRESHOLD, SOCIAL_MEDIA_DOMAINS)
...
from .user_agent_generator import (UAGen,  # , OnlineUAGenerator
                                   ValidUAGenerator)
...
class CrawlerRunConfig:
    ...
    def to_dict(self):
        return {
            ...
            "link_preview_config": (
                self.link_preview_config.to_dict() if self.link_preview_config else None
            ),
            "url": self.url,
