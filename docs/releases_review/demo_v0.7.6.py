...
def demo_1_crawl_webhook_notification_only():
    ...
    payload = {
        ...
        "webhook_config": {
            ...
            "webhook_headers": {"X-Demo": "v0.7.6", "X-Type": "crawl"},
        },
    }
...
def demo_2_crawl_webhook_with_data():
    ...
    payload = {
        ...
        "webhook_config": {
            ...
            "webhook_headers": {"X-Demo": "v0.7.6", "X-Type": "crawl-with-data"},
        },
    }
...
def demo_3_llm_webhook_notification_only():
    ...
    payload = {
        ...
        "webhook_config": {
            "webhook_url": f"{WEBHOOK_BASE_URL}/webhook",
            "webhook_data_in_payload": False,
            "webhook_headers": {"X-Demo": "v0.7.6", "X-Type": "llm"},
        },
    }
...
def demo_4_llm_webhook_with_schema():
    ...
    payload = {
        ...
        "webhook_config": {
            "webhook_url": f"{WEBHOOK_BASE_URL}/webhook",
            "webhook_data_in_payload": True,
            "webhook_headers": {"X-Demo": "v0.7.6", "X-Type": "llm-with-schema"},
        },
    }
...
def main():
    ...
    try:
        ...
        print(
            "  docker run -d -p 11235:11235 --env-file .llm.env unclecode/crawl4ai:0.7.6"
        )
        return
