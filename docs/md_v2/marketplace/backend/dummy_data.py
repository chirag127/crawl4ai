...
def generate_dummy_data():
    ...
    apps_data = [
        ...
        (
            ...
            True,
            True,
            "Scalable browser automation in the cloud with Playwright",
            "https://playwright.cloud",
            None,
            "$99/month starter",
            4.8,
            12500,
        ...
        (
            ...
            False,
            False,
            "Distributed Selenium grid for parallel testing",
            "https://seleniumhub.io",
            "https://github.com/seleniumhub/grid",
            "Free - $299/month",
            4.2,
            8400,
        ...
        (
            ...
            True,
            False,
            "Enhanced Puppeteer with stealth plugins and more",
            "https://puppeteer-extra.dev",
        ...
        (
            ...
            True,
            True,
            "Premium proxy network with 72M+ IPs worldwide",
        ...
        (
            ...
            False,
            False,
            "Rotating proxy servers with sticky sessions",
            "https://proxymesh.com",
            None,
            "$10-$50/month",
            4.0,
        ...
        (
            ...
            True,
            False,
            "LangChain integration for Crawl4AI workflows",
            "https://langchain-crawl.dev",
            "https://github.com/langchain/crawl",
            "Free",
            4.5,
            18900,
        ...
        (
            ...
            False,
            False,
            "Extract structured data using GPT models",
            "https://gptscraper.ai",
            None,
            "Free - $99/month",
            4.1,
        ...
        (
            ...
            True,
            True,
            "Professional extraction using Claude AI",
            "https://claude-extract.com",
            None,
            "$199/month",
            4.9,
            3200,
        ...
        (
            ...
            True,
            True,
            "Simple API for web scraping with proxy rotation",
        ...
        (
            ...
            True,
            True,
            "Managed headless browsers in the cloud",
        ...
        (
            ...
            True,
            False,
            "VSCode extension for Crawl4AI development",
            "https://marketplace.visualstudio.com",
            "https://github.com/crawl4ai/vscode",
            "Free",
            4.8,
            34500,
        ...
        (
            ...
            False,
            False,
            "Postman collection for Crawl4AI API testing",
            "https://postman.com/crawl4ai",
            "https://github.com/crawl4ai/postman",
            "Free",
            4.3,
            7800,
        ...
        (
            ...
            False,
            False,
            "Debugging tools for crawler development",
            "https://debug.crawl4ai.com",
            "https://github.com/crawl4ai/debug",
            "Free",
            4.0,
            4300,
    ...
    articles_data = [
        (
            ...
            "Review",
            "John Doe",
            ["Playwright Cloud", "Puppeteer Extra"],
        ...
        (
            ...
            "Comparison",
            "Jane Smith",
            ["BrightData", "SmartProxy", "ProxyMesh"],
        ...
        (
            ...
            "Tutorial",
            "Crawl4AI Team",
            ["LangChain Crawl", "GPT Scraper", "Claude Extract"],
        ...
        (
            ...
            "Comparison",
            "Sarah Chen",
            ["BrowserCloud", "LambdaTest", "Browserless"],
        ...
        (
            ...
            "Tutorial",
            "Crawl4AI Team",
            ["Playwright Cloud", "Selenium Grid Hub"],
