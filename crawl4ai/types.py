...
if TYPE_CHECKING:
    ...
    from .async_configs import \
        BrowserConfig as \
        BrowserConfigType  # NEW: Import SeedingConfig for type checking
    from .async_configs import CrawlerRunConfig as CrawlerRunConfigType
    from .async_configs import HTTPCrawlerConfig as HTTPCrawlerConfigType
    from .async_configs import LLMConfig as LLMConfigType
    from .async_configs import SeedingConfig as SeedingConfigType
    # Dispatcher imports
    from .async_dispatcher import BaseDispatcher as BaseDispatcherType
    from .async_dispatcher import CrawlerMonitor as CrawlerMonitorType
    from .async_dispatcher import DisplayMode as DisplayModeType
    from .async_dispatcher import \
        MemoryAdaptiveDispatcher as MemoryAdaptiveDispatcherType
    from .async_dispatcher import RateLimiter as RateLimiterType
    from .async_dispatcher import RunManyReturn as RunManyReturnType
    from .async_dispatcher import \
        SemaphoreDispatcher as SemaphoreDispatcherType
    from .async_logger import AsyncLogger as AsyncLoggerType
    from .async_logger import AsyncLoggerBase as AsyncLoggerBaseType
    ...
    from .async_webcrawler import CacheMode as CacheModeType
    from .browser_profiler import BrowserProfiler as BrowserProfilerType
    # Chunking imports
    from .chunking_strategy import ChunkingStrategy as ChunkingStrategyType
    from .chunking_strategy import RegexChunking as RegexChunkingType
    ...
    from .deep_crawling import BFSDeepCrawlStrategy as BFSDeepCrawlStrategyType
    from .deep_crawling import CompositeScorer as CompositeScorerType
    from .deep_crawling import ContentTypeFilter as ContentTypeFilterType
    from .deep_crawling import DeepCrawlDecorator as DeepCrawlDecoratorType
    from .deep_crawling import DeepCrawlStrategy as DeepCrawlStrategyType
    from .deep_crawling import DFSDeepCrawlStrategy as DFSDeepCrawlStrategyType
    from .deep_crawling import \
        DomainAuthorityScorer as DomainAuthorityScorerType
    from .deep_crawling import DomainFilter as DomainFilterType
    from .deep_crawling import FilterChain as FilterChainType
    from .deep_crawling import FilterStats as FilterStatsType
    from .deep_crawling import FreshnessScorer as FreshnessScorerType
    from .deep_crawling import \
        KeywordRelevanceScorer as KeywordRelevanceScorerType
    from .deep_crawling import PathDepthScorer as PathDepthScorerType
    from .deep_crawling import SEOFilter as SEOFilterType
    from .deep_crawling import URLFilter as URLFilterType
    from .deep_crawling import URLScorer as URLScorerType
    # Docker client
    ...
    from .models import \
        MarkdownGenerationResult as MarkdownGenerationResultType
    # Proxy imports
