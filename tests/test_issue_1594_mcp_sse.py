...
class TestMCPSSERouting:
    ...
    def test_uses_starlette_route_for_sse(self):
        ...
        source = self._get_source()
        assert (
            "from starlette.routing import Route" in source
            or "from starlette.routing import Route, Mount" in source
