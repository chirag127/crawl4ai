...
class TestDeepCrawlOutput:
    ...
    def test_deep_crawl_markdown_output_includes_all_pages(
        self, runner, mock_crawl_results
    ):
    ...
    def test_deep_crawl_markdown_fit_output_includes_all_pages(
        self, runner, mock_crawl_results
    ):
    ...
    def test_deep_crawl_file_output_includes_all_pages(
        self, runner, mock_crawl_results, tmp_path
    ):
    ...
    def test_single_crawl_markdown_output_unchanged(self, runner):
        ...
        with patch("crawl4ai.cli.anyio.run") as mock_anyio_run:
            ...
            result = runner.invoke(
                cli, ["crawl", "https://example.com", "-o", "markdown"]
            )
