...
from .async_configs import (BrowserConfig, CrawlerRunConfig, ProxyConfig,
                            SeedingConfig)
from .async_crawler_strategy import (AsyncCrawlerStrategy, AsyncCrawlResponse,
...
from .models import (CrawlResult, CrawlResultContainer, DispatchResult,
                     MarkdownGenerationResult, RunManyReturn, ScrapingResult)
from .utils import (InvalidCSSSelectorError, RobotsParser,
                    compute_head_fingerprint, fast_format_html,
                    get_error_context, preprocess_html_for_schema,
                ...
                if not cached_result or not html:
                        ...
                        for _p_idx, _proxy in enumerate(_proxy_list):
                            ...
                            try:
                                ...
                                crawl_result = await self.aprocess_html(
                                    ...
                                    is_raw_html=(
                                        True if url.startswith("raw:") else False
                                    ),
                    ...
                    if crawl_result:
                        ...
                        crawl_result = CrawlResult(
                            ...
                            status_code=None,
                            error_message=(
                                f"All proxies failed: {_block_reason}"
                                if _block_reason
