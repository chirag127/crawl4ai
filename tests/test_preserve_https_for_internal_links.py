...
def demonstrate_issue():
    ...
    redirected_url = (
        "http://quotes.toscrape.com/tag/deep-thoughts/"  # Server redirects to HTTP
    )
...
def demonstrate_solution():
    ...
    def normalize_url_with_preservation(
    ...
    resolved_without = normalize_url_with_preservation(
        relative_link, redirected_url, preserve_https=False, original_scheme="https"
    )
    ...
    resolved_with = normalize_url_with_preservation(
        relative_link, redirected_url, preserve_https=True, original_scheme="https"
    )
