...
class SimpleApiTester:
    ...
    def print_result(self, result: Dict):
        ...
        status_color = {"PASS": "✅", "FAIL": "❌", "SKIP": "⏭️"}

        print(
            f"{status_color[result['status']]} {result['method']} {result['endpoint']} "
    ...
    def run_all_tests(self):
        ...
        md_payload = {"url": test_url, "f": "fit", "q": "test query", "c": "0"}
        ...
        screenshot_payload = {"url": test_url, "screenshot_wait_for": 2}
        ...
        js_payload = {"url": test_url, "scripts": ["(() => document.title)()"]}
        result = self.test_post_endpoint("/execute_js", js_payload)
        self.print_result(result)

        # Test crawl endpoint
        crawl_payload = {"urls": [test_url], "browser_config": {}, "crawler_config": {}}
        ...
        # Test LLM job
        llm_job_payload = {"url": test_url, "q": "Extract main content", "cache": False}
